        ...
        <div class="erp-grid-container">
            ...
            <div class="row">
                <div class="invoice-number">
                    <?php
                        $invoice = isset( $transaction->invoice_number ) && ! empty( $transaction->invoice_number ) ? erp_ac_get_invoice_number( $transaction->invoice_number, $transaction->invoice_format ) : $transaction->id;
