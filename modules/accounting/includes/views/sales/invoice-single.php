...
<!--                        <li><a href="#" class="invoice-duplicate">--><?php //_e( 'Duplicate', 'erp' ); ?><!--</a></li>-->
            ...
            <div class="row">
                <div class="invoice-number">
                    <?php
                        $ivoice = isset( $transaction->invoice_number ) && ! empty( $transaction->invoice_number ) ? erp_ac_get_invoice_number( $transaction->invoice_number, $transaction->invoice_format ) : $transaction->id;
