...
?>
    <h2><?php echo $customer->get_full_name(); ?> <a href="<?php echo $edit_url; ?>" class="add-new-h2"><?php _e( 'Edit', 'accounting' ); ?></a></h2>
    ...
    <h2 class="nav-tab-wrapper erp-nav-tab-wrapper" style="margin: 20px 0;">
        <a class="nav-tab<?php echo $current_tab == 'transactions' ? ' nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=erp-accounting-customers&action=view&id=' . $id . '&tab=transactions' ); ?>"><?php _e( 'Transactions', 'accounting' ); ?></a>
        <a class="nav-tab<?php echo $current_tab == 'details' ? ' nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page=erp-accounting-customers&action=view&id=' . $id . '&tab=details' ); ?>"><?php _e( 'User Details', 'accounting' ); ?></a>
    </h2>
