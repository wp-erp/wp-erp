            ...
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        ...
                        <th><?php _e( 'Tax Number', 'accounting' ); ?></th>
                        <th><?php _e( 'Tax Rate(%)', 'accounting' ); ?></th>
                        <th><?php _e( 'Edit', 'accounting' ); ?></th>
                        <th><?php _e( 'Delete', 'accounting' ); ?></th>
                    </tr>
                </thead>
                <tbody>
                <?php
                if ( ! $taxs ) {
                    ?>
                    <tr>    
                        <td colspan="5"><?php _e( 'No data found!', 'accounting' ); ?></td>
                    </tr>
                    <?php
                }
                ...
                foreach ( $taxs as $key => $tax ) {
                    ...
                    <tr>    
                        ...
                        <td><a data-is_edit="<?php echo '1'; ?>" data-id="<?php echo $tax->id; ?>" data-items='<?php echo json_encode( $tax ); ?>' class="erp-ac-tax-edit" href="#"><?php _e( 'Edit', 'accounting' ); ?></a></td>
                        <td><a data-tax_id="<?php echo $tax->id; ?>" data-items='<?php echo json_encode( $tax ); ?>' class="erp-ac-tax-delete" href="#"><?php _e( 'Delete', 'accounting' ); ?></a></td>
                    </tr>
                    <?php
                }
