        ...
        <div class="erp-grid-container">
                ...
                <div class="row invoice-buttons erp-hide-print">
                    <div class="col-6">
                        <?php if ( $status ) {
                            ...
                            ?>
                            <a href="<?php echo $url; ?>" class="button button-large"><?php _e( 'Edit Voucher', 'accounting' ); ?></a>
                            <?php
                        }
                        ?>
                    </div>
            ...
            <div class="row">
                <div class="invoice-number">
                    <?php printf( __( 'Voucher: <strong>%d</strong>', 'accounting' ), $transaction->id ); ?>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-3 align-right">
                    <table class="table info-table">
                        <tbody>
                            <tr>
                                <th><?php _e( 'Voucher Number', 'accounting' ); ?>:</th>
                                <td><?php echo $transaction->id; ?></td>
                            </tr>
                            <tr>
                                <th><?php _e( 'Voucher Date', 'accounting' ); ?>:</th>
