<div class="wrap erp-accounting">
    ...
    <h2 class="nav-tab-wrapper erp-nav-tab-wrapper" style="margin: 20px 0;">
        <a class="nav-tab<?php echo $current_tab == 'transactions' ? ' nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page='.$page.'&section='.$section.'&action=view&id=' . $id . '&tab=transactions' ); ?>"><?php _e( 'Transactions', 'erp-accounting' ); ?></a>
        <a class="nav-tab<?php echo $current_tab == 'details' ? ' nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'admin.php?page='.$page.'&section='.$section.'&action=view&id=' . $id . '&tab=details' ); ?>"><?php _e( 'User Details', 'erp-accounting' ); ?></a>
    </h2>
