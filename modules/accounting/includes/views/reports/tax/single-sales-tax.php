<div class="wrap erp-ac-tax-report-wrap">
	...
	<h2><?php _e( 'Sales Tax Summary', 'accounting' ); ?>
		<a class="add-new-h2" href="<?php echo erp_ac_get_sales_tax_report_url(); ?>">&#8592;<?php _e( 'Back', 'accounting' ); ?></a>
	</h2>
	...
	<table class="wp-list-table widefat fixed striped erp-ac-tax-report-table">
		<thead>
			<tr>
				<th class="erp-ac-single-tax-report-table"><?php _e( 'Transaction ID', 'accounting' ); ?></th>
				<th class="erp-ac-single-tax-report-table"><?php _e( 'Transaction Date', 'accounting' ); ?></th>
				<th class="erp-ac-single-tax-report-table" colspan="2"><?php _e( 'Tax Payable', 'accounting' ); ?></th>
				<th class="erp-ac-single-tax-report-table" colspan="2"><?php _e( 'Tax Receivable', 'accounting' ); ?></th>
			</tr>
			<tr>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
