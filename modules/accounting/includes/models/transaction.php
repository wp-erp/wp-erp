...
class Transaction extends Model {
    ...
    protected $fillable   = [ 'type', 'form_type', 'status', 'user_id', 'billing_address', 'ref', 'summary', 'issue_date', 'due_date', 'currency', 'conversion_rate', 'sub_total', 'total', 'due', 'trans_total', 'invoice', 'files', 'created_by', 'created_at'];
