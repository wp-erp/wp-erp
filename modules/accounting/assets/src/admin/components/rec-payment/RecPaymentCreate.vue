                ...
                <div class="wperp-panel-body">
                    ...
                    <form action="" class="wperp-form" method="post">
                        <div class="wperp-row">
                            ...
                            <div class="wperp-col-sm-4">
                                <div class="wperp-form-group">
                                    <label>{{ __('Payment Date', 'erp') }}<span
                                        class="wperp-required-sign">*</span></label>
                                    <datepicker v-model="basic_fields.payment_date"></datepicker>
                                </div>
                            </div>
                            <div class="wperp-col-sm-4 with-multiselect">
                                <label>{{ __('Payment Method', 'erp') }}<span
                                    class="wperp-required-sign">*</span></label>
                            ...
                            <div class="wperp-col-sm-4">
                                ...
                                <select-accounts v-model="basic_fields.deposit_to" :reset="reset"
                                                 :override_accts="accts_by_chart"></select-accounts>
                            </div>
                            ...
                            <div class="wperp-col-sm-4">
                                ...
                                <textarea v-model.trim="basic_fields.billing_address" rows="4" class="wperp-form-field"
                                          :placeholder="__('Type here', 'erp')"></textarea>
                            </div>

                            <check-fields v-if="basic_fields.trn_by.id === '3'"
                                          @updateCheckFields="setCheckFields"></check-fields>
                        </div>
                    </form>
                    ...
                    <table class="wperp-table wperp-form-table">
                        ...
                        <tr :key="key" v-for="(invoice,key) in invoices">
                            ...
                            <td class="col--amount" data-colname="Amount">
                                <input type="number" min="0" step="0.01" v-model="totalAmounts[key]"
                                       @keyup="updateFinalAmount" class="wperp-form-field text-right"/>
                            </td>
                        ...
                        <tr class="wperp-form-group">
                            <td colspan="9" style="text-align: left;">
                                ...
                                <textarea v-model="particulars" rows="4" maxlength="250"
