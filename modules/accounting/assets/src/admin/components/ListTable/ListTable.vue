<template>
    <div :class="{ 'table-loading': loading }">
                ...
                <span v-if="hasPagination" class="pagination-links">
                    ...
                    <span class="paging-input">
                        <span class="tablenav-paging-text">
                            <input :value="currentPage" class="current-page" type="text" name="paged"
        ...
        <table :class="tableClass">
            ...
            <tr v-else>
                <td v-if="showCb" class="manage-column column-cb check-column"><input v-model="selectAll"
                                                                                      type="checkbox"></td>
                    ...
                    <td v-for="(value, key) in columns" :key="key"
                        ...
                        <div v-if="actionColumn === key && hasActions" class="row-actions">
                            <slot :row="row" name="row-actions">
                                ...
                                <row-actions :row="row" :actions="actions"/>
