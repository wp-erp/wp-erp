...
// CRM module loads on `init` (after `plugins_loaded` has already fired), so
// hooking `plugins_loaded` here would never run. Use `erp_crm_loaded`, which
// fires at the end of CRM::__construct once all CRM function files are loaded.
