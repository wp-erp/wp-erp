        ...
        <div class="feed-schedule-wrapper">
            ...
            <div class="schedule-title-assign-user">
                <p class="erp-left schedule-title">
                    <input type="text" required name="schedule_title" placeholder="<?php _e( 'Enter Schedule Title', 'wp-erp' ); ?>">
                </p>
            ...
            <div class="schedule-datetime">
                ...
                <p class="erp-left schedule-all-day">
                    <input type="checkbox" name="all_day" value="true"> <?php _e( 'All Day', 'wp-erp' ); ?>
                </p>
                <div class="clearfix"></div>
            </div>
            <p>
            ...
            <div class="schedule-notification">
                ...
                <p class="erp-left schedule-notification-allow">
                    <input type="checkbox" name="allow_notification" value="true"> <?php _e( 'Allow notification', 'wp-erp' ); ?>
                </p>
                <div class="clearfix"></div>
            </div>
                ...
                <p class="erp-left schedule-notification-via">
                    ...
                    <span class="value">
                        <select name="notification_via" id="notification_via">
                            ...
                            <option value="sms" value="disabled"><?php _e( 'SMS', 'wp-erp' ); ?></option>
                        </select>
                    </span>
                </p>
    ...
    <# } else { #>
        <div class="feed-log-activity">
            ...
            <p class="log-email-subject erp-hide">
                ...
                <span class="sep">:</span>
                <span class="value">
                    <input type="text" class="email_subject" name="email_subject" placeholder="<?php _e( 'Subject log...', 'wp-erp' ); ?>">
                </span>
            </p>
