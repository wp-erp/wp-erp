<div class="performance-tab-wrap">
    ...
    if ( current_user_can('erp_create_review') ||
        ...
        <a href="#" id="erp-empl-performance-reviews" class="action button"
           ...
           data-title="<?php _e( 'Performance Reviews', 'erp' ); ?>"><span
                class="dashicons dashicons-plus erp-performance-dashicon"></span> <?php _e( 'Add Performance Reviews', 'erp' ); ?>
        </a>
        <?php
    }
    ?>
    ...
    <table class="widefat">
        ...
        <tr>
            ...
            <th><?php _e( 'Dependability', 'erp' ) ?></th>
            <th>&nbsp;</th>
        </tr>
        </thead>
    ...
    if ( current_user_can('erp_create_review') ||
        ...
        <a href="#" id="erp-empl-performance-comments" class="action button"
           ...
           data-title="<?php _e( 'Performance Comments', 'erp' ); ?>"><span
                class="dashicons dashicons-plus erp-performance-dashicon"></span> <?php _e( 'Add Performance Comments', 'erp' ); ?>
        </a>
    <?php } ?>
