<div class="wrap">
    ...
    $erp_doc_sections = array(
        ...
        __( 'Employee Management', 'erp' ) => array(
                                    ...
                                    <div class="erp-help-questions">
                                        <ul>
                                            <?php foreach ($docs as $title => $link) { ?>
                                                <li><a href="<?php echo esc_url( add_query_arg(array('ref' =>'erp_help_doc'), $link) ); ?>" target="_blank"><?php echo esc_html( $title ); ?> <span class="dashicons dashicons-arrow-right-alt2"></span></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                <?php } ?>
