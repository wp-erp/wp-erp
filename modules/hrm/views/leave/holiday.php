...
class Leave_Holiday_List_Table extends WP_List_Table {
    ...
    function column_name( $holiday ) {
        ...
        $actions['delete'] = sprintf( '<a href="%s" class="erp-hr-holiday-delete" data-id="%d" title="%s">%s</a>', $delete_url, $holiday->id, __( 'Delete this item', 'wp-erp' ), __( 'Delete', 'wp-erp' ) );
...
<div class="wrap erp-hr-holiday-wrap">
    <h2><?php _e( 'Holiday', 'wp-erp' ); ?> <a href="#" id="erp-hr-new-holiday" class="add-new-h2"><?php _e( 'Add New', 'wp-erp' ); ?></a><a href="#import-ical" id="erp-hr-import-ical" class="add-new-h2"><?php _e( 'Import ICal', 'wp-erp' ); ?></a></h2>
