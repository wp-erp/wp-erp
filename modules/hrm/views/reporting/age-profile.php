<div class="wrap">
	<h2><?php _e( 'Age Profile', 'wp-erp' ); ?></h2>
	...
	<div class="erp-single-container">
		...
		<?php
			...
			echo erp_admin_dash_metabox( __( '<i class="fa fa-bar-chart-o"></i> Employee Age Breakdown by Department', 'wp-erp' ), function() {
		?>
		...
		<table class="widefat">
			<thead>
				<tr>
					...
					<th><?php _e( 'Under 18 year', 'wp-erp' ); ?></th>
					<th><?php _e( '18 to 25 year', 'wp-erp' ); ?></th>
					<th><?php _e( '26 to 35 year', 'wp-erp' ); ?></th>
					<th><?php _e( '36 to 45 year', 'wp-erp' ); ?></th>
					<th><?php _e( '46 to 55 year', 'wp-erp' ); ?></th>
					<th><?php _e( '56 to 65 year', 'wp-erp' ); ?></th>
					<th><?php _e( '65+ year', 'wp-erp' ); ?></th>
				</tr>
			</thead>
			<tbody>
			<?php
