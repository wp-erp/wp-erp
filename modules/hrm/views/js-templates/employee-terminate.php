...
<div class="terminate-form-wrap">
    <div class="row">
        <?php erp_html_form_input( array(
            'label'    => __( 'Termination Date', 'wp-erp' ),
            'name'     => 'terminate_date',
    ...
    <div class="row" data-selected="{{ data.termination_type }}">
        <?php erp_html_form_input( array(
            'label'   => __( 'Termination Type', 'wp-erp' ),
            ...
            'required' => true,
            'id'      => 'termination_type',
            'options' => array( '' => __( '- Select -', 'wp-erp' ) ) + erp_hr_get_terminate_type()
        ) ); ?>
    </div>

    <div class="row" data-selected="{{ data.termination_reason }}">
        <?php erp_html_form_input( array(
            'label'   => __( 'Termination Reason', 'wp-erp' ),
            ...
            'options' => array( '' => __( '- Select -', 'wp-erp' ) ) + erp_hr_get_terminate_reason()
        ) ); ?>
    </div>

    <div class="row" data-selected="{{ data.eligible_for_rehire }}">
        <?php erp_html_form_input( array(
            'label'   => __( 'Eligible for Rehire', 'wp-erp' ),
            ...
            'options' => array( '' => __( '- Select -', 'wp-erp' ) ) + erp_hr_get_terminate_rehire_options()
        ) ); ?>
    </div>
