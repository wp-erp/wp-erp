...
//add_action( 'erp_daily_scheduled_events', 'erp_hr_apply_entitlement_yearly' ); //@since 1.6.0
//add_action( 'erp_hr_leave_policy_new', 'erp_hr_apply_policy_existing_employee', 10, 2 ); //@since 1.6.0
