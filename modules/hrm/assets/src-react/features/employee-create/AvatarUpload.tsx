				...
				{ busy ? (
					...
					<>
						<Button
							...
							variant="ghost"
							size="icon"
							className="pointer-events-auto size-8 rounded-full bg-white/90 text-foreground hover:bg-white"
						...
						{ avatarUrl ? (
							<Button
								...
								variant="ghost"
								size="icon"
								className="pointer-events-auto size-8 rounded-full bg-white/90 text-destructive hover:bg-white"
