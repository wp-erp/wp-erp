...
export const TOPBAR_NAV_ITEMS: ReadonlyArray< NavItem > = [
	...
	},
	{
		...
		children: [
			...
			// Legacy registered these two as their own submenu pages
			// (recruitment/includes/AdminMenu.php: "Add Opening", "Add candidate").
			// The routes already existed here; only the shortcuts were missing, so
			// reaching either form took two clicks instead of one. Labels are the
			// legacy strings verbatim.
			...
			{ id: 'recruitment-reports', label: __( 'Reports', 'erp' ), to: '/recruitment/reports', capabilities: [ 'manage_recruitment' ] },
			{ id: 'recruitment-ai-settings', label: __( 'AI Settings', 'erp' ), to: '/recruitment/ai-settings', capabilities: [ 'manage_recruitment' ] },
			{ id: 'recruitment-ai-talent-pool', label: __( 'AI Talent Pool', 'erp' ), to: '/recruitment/ai-talent-pool', capabilities: [ 'manage_recruitment' ] },
			{ id: 'recruitment-ai-job-settings', label: __( 'AI Job Settings', 'erp' ), to: '/recruitment/ai-job-settings', capabilities: [ 'manage_recruitment' ] },
			{ id: 'recruitment-ai-job-writer', label: __( 'AI Job Writer', 'erp' ), to: '/recruitment/ai-job-writer', capabilities: [ 'manage_recruitment' ] },
		],
	},
	{
		id:            'asset',
