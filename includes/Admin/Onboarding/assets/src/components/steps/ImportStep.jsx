      ...
      <div>
        <div className="max-w-640px mx-auto overflow-visible">
          ...
          <div className="bg-white rounded-2xl p-24 text-center my-8 max-w-640px max-h-340px border border-gray-300">
            ...
            <p className="text-slate-500 text-sm leading-5 m-0 font-normal">{importedCount} {importedCount === 1 ? 'employee has' : 'employees have'} been imported</p>
          </div>
    ...
    <div>
      ...
      <div className="max-w-640px mx-auto overflow-visible">
        ...
        <p className="text-center text-slate-500 text-base m-0 mb-16 leading-6">
          Import your employee list via CSV file (optional)
        </p>
