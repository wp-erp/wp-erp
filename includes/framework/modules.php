...
class Modules {
    ...
    public function get_modules_extensions() {
        ...
        if ( ! $this->modules_extensions ) {
            ...
            $current_path = explode( '/', __DIR__ ); // Get current directory path
            array_splice( $current_path, count( $current_path ) - 3, 3 ); // Get the plugins actual directory path
            $pro_plugin_dir = implode( '/', $current_path ) . '/erp-pro/modules'; // get erp-pro module directory path
            ...
            $this->modules_extensions = [
                'advanced_leave' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/advanced-leave/Module.php',
                ...
                'awesome_support' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/awesome-support/Module.php',
                ...
                'gravity_forms' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/gravity_forms/Module.php',
                ...
                'help_scout' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/help-scout/Module.php',
                ...
                'hr_frontend' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/hr-frontend/Module.php',
                ...
                'hubspot' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/hubspot/Module.php',
                ...
                'mailchimp' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/mailchimp/Module.php',
                ...
                'salesforce' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/salesforce/Module.php',
                ...
                'zendesk' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/pro/zendesk/Module.php',
                ...
                'asset_management' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/asset-management/Module.php',
                ...
                'attendance' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/attendance/Module.php',
                ...
                'custom_field_builder' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/custom-field-builder/Module.php',
                ...
                'document_manager' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/document-manager/Module.php',
                ...
                'hr_training' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/hr-training/Module.php',
                ...
                'payroll' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/payroll/Module.php',
                ...
                'recruitment' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/recruitment/Module.php',
                ...
                'reimbursement' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/reimbursement/Module.php',
                ...
                'sms_notification' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/sms-notification/Module.php',
                ...
                'workflow' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/hrm/workflow/Module.php',
                ...
                'deals' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/crm/deals/Module.php',
                ...
                'inventory' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/accounting/inventory/Module.php',
                ...
                'payment_gateway' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/accounting/payment-gateway/Module.php',
                ...
                'woocommerce' => [
                    ...
                    'module_file'   => $pro_plugin_dir . '/accounting/woocommerce/Module.php',
