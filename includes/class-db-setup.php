 ...
 * @author WP ERP
 */
class WPERP_DB_Setup {

    private $collate = '';

    /**
     * Define tables for the activated modules
     * 
     * @since 1.3.13
     * 
     * @return void
     */
    public function create_active_module_tables() {
        $table_schemas = [];

        if ( erp_is_module_active( 'hrm' ) ) {
            $table_schemas = array_merge( $table_schemas, $this->define_hrm_tables() );
        }

        if ( erp_is_module_active( 'crm' ) || erp_is_module_active( 'accounting' ) ) {
            $table_schemas = array_merge( $table_schemas, $this->define_ac_crm_general_tables() );
        }

        if ( erp_is_module_active( 'crm' ) ) {
            $table_schemas = array_merge( $table_schemas, $this->define_crm_tables() );
        }

        if ( erp_is_module_active( 'accounting' ) ) {
            $table_schemas = array_merge( $table_schemas, $this->define_ac_tables() );
        }

        $this->create_tables( $table_schemas );
    }
    ...
    public function create_base_tables() {
        $this->create_tables( $this->define_base_tables() );
    }
     ...
     * @return void
     */
    private function create_tables( $schemas ) {
     ...
     * @return void
     */
    public function populate_initial_data() {
        if ( erp_is_module_active( 'crm' ) || erp_is_module_active( 'accounting' ) ) {
            $this->populate_ac_crm_general_data();
        }

        if ( erp_is_module_active( 'crm' ) ) {
            $this->populate_crm_data();
        }

        if ( erp_is_module_active( 'accounting' ) ) {
            $this->populate_ac_data();
        }
    }
     ...
     * @return array
     */
    public function define_base_tables() {
        global $wpdb;
     ...
     * @return array
     */
    public function define_hrm_tables() {
        global $wpdb;
    ...
    /**
     * Define accounting and crm (general) tables
     * 
     * @since 1.3.13
     *
     * @return array
     */
    public function define_ac_crm_general_tables() {
        global $wpdb;
     ...
     * @return array
     */
    public function define_crm_tables() {
        global $wpdb;
    ...
    /**
     * Define accounting tables
     * 
     * @since 1.3.13
     *
     * @return array
     */
    public function define_ac_tables() {
        global $wpdb;
     ...
     * @return void
     */
    public function populate_ac_data() {
        global $wpdb;
    ...
    /**
     * Populate accounting and crm general data
     * 
     * @since 1.3.13
     *
     * @return void
     */
    public function populate_ac_crm_general_data() {
        global $wpdb;
    ...
    /**
     * Populate crm tables with initial data
     * 
     * @since 1.3.13
     *
     * @return void
     */
    public function populate_crm_data() {
        global $wpdb;
