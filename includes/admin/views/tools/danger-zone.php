<div class="erp-grid-container tools-section erp-danger-zone">
    ...
    <div class="tools-alert tools-alert-warning">
        ...
        <p><?php esc_html_e( 'The reset makes a fresh installation of your database. Therefore any data related to Wp ERP in your database will be lost. Please do not use this option if you do not want to delete all of your WP ERP data.', 'erp' ); ?></p>
    </div>
    ...
    <div class="tools-alert tools-alert-info display-flex tools-alert-no-title">
        ...
        <p class="tools-alert-description-text">
            <?php esc_html_e( 'The reset does not delete of modified any of your other files/data of the site. It will only remove data related to WP ERP', 'erp' ); ?>
        </p>
    </div>

    <div class="tools-card">
        <h4 class="tools-content-header"><?php esc_html_e( 'Reset if you are well aware about that!', 'erp' ); ?></h4>
