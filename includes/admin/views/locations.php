<div class="wrap">
    ...
    <h2><?php _e( 'Company Locations', 'wp-erp' ); ?></h2>

    <table class="table table-details">
  <tbody>
    <tr>
      <td class="name"><?php _e( 'Filing Address', 'wp-erp' ); ?></td>
      <td class="value">
...
<br>
    ...
    <tr>
      <td class="name"><?php _e( 'Mailing Address', 'wp-erp' ); ?></td>
      <td class="value">
...
<h2><?php _e( 'All Company Locations', 'wp-erp' ); ?></h2>
